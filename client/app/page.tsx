  ...
  const coreFeatures = [
    {
      ...
      description:
        "Search across multiple indexers simultaneously. Find exactly what you're looking for, faster.",
      page: "/pages/search",
    },
    {
      ...
      description:
        "Browse thousands of movies with filters, ratings, and streaming availability. Beautiful Netflix-like interface.",
    ...
    },
    {
      ...
      description:
        "Explore TV shows, track seasons and episodes. Never miss your favorite series.",
    ...
    },
    {
      ...
      description:
        "Connect unlimited torrent and NZB indexers. Test, configure, and prioritize with ease.",
      page: "/pages/indexers",
    },
    {
      ...
      description:
        "Integrate qBittorrent, Transmission, SABnzbd, and more. Full control over categories and priorities.",
    ...
    },
    {
      ...
      description:
        "Automated tracking and downloading. Set quality profiles and let BorrowArr handle the rest.",
    ...
    },
    {
      ...
      description:
        "Track everything you've downloaded. Complete transparency and organization.",
      page: "/pages/history",
    },
    {
      ...
      title: "Favorites",
      description:
        "Save and organize your favorite movies and shows. Quick access to what matters.",
    ...
    },
    {
      ...
      title: "Media Library",
      description:
        "Manage your entire media collection in one place. Plex integration included.",
    ...
    },
    {
      ...
      description:
        "Organize, rename, and manage your media files with intelligent automation.",
    ...
    },
    {
      ...
      description:
        "Detailed analytics on your downloads, storage, and activity.",
      page: "/pages/stats",
    },
    {
      ...
      description:
        "Fine-tune every aspect. Quality profiles, naming conventions, and more.",
      page: "/pages/settings",
    },
  ];
  ...
  const keyBenefits = [
    {
      ...
      description:
        "Why run 4 separate applications when you can have everything in one? BorrowArr combines the power of Radarr, Sonarr, Prowlarr, and Overseerr into a single, unified platform.",
    ...
    },
    {
      ...
      description:
        "Get up and running in minutes, not hours. Connect your indexers, add your download clients, and start discovering content immediately.",
    ...
    },
    {
      ...
      description:
        "Your server, your rules, your data. BorrowArr runs entirely on your infrastructure. No cloud dependencies, no external services, complete privacy.",
    ...
    },
    {
      ...
      description:
        "BorrowArr is just a tool. You bring your own indexers and download clients. We provide the interface, you control the content. Fully compliant and transparent.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background-dark to-background text-foreground overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-secondary/10 rounded-full blur-3xl pulse-glow"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute top-1/2 left-1/2 w-96 h-96 bg-secondary/5 rounded-full blur-3xl pulse-glow"
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-foreground/60 max-w-3xl mx-auto mb-10 leading-relaxed">
              Stop juggling multiple applications. BorrowArr is the unified
              ...
              <span className="text-secondary font-semibold"> Prowlarr</span>,
              and
              <span className="text-secondary font-semibold">
                {" "}
                Overseerr
              </span>{" "}
              into one beautiful, self-hosted solution.
            </p>
              ...
              <div className="bg-content2/50 backdrop-blur-xl rounded-3xl p-8 border border-secondary/20">
                <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                  ...
                  <div className="flex-1">
                    <div className="text-foreground/60 text-sm font-semibold mb-4 uppercase tracking-wide">
                      The Old Way
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      {competitorApps.map((app, idx) => {
                        ...
                        return (
                          <div
                            className="bg-content3/50 rounded-xl p-4 border border-default-200"
                            key={idx}
                          >
                    ...
                    <div className="mt-3 text-xs text-danger font-semibold">
                      4 Different Apps to Manage
                    </div>
                  </div>
                  ...
                  {/* BorrowArr */}
                  <div className="flex-1">
                    <div className="text-secondary text-sm font-semibold mb-4 uppercase tracking-wide">
                      The BorrowArr Way
                    </div>
                    <div className="bg-gradient-to-br from-secondary/20 to-secondary/10 rounded-xl p-6 border-2 border-secondary/50 hover-lift">
                      ...
                      <div className="text-xl font-bold text-secondary mb-2 neon-text">
                        BorrowArr
                      </div>
            ...
            <div className="text-center mb-16">
              ...
              <div className="max-w-4xl mx-auto">
                <p className="text-foreground/80 text-lg leading-relaxed mb-6">
                  <strong className="text-secondary">BorrowArr</strong> is the{" "}
                  <strong>
                    all-in-one self-hosted media management platform
                  </strong>{" "}
                  that eliminates the need to run multiple separate
                  applications. Instead of juggling Radarr for movies, Sonarr
                  for TV shows, Prowlarr for indexers, and Overseerr for
                  requests, you get everything in a single, beautifully designed
                  application.
                </p>
                <p className="text-foreground/80 text-lg leading-relaxed mb-6">
                  Connect your favorite{" "}
                  <strong className="text-secondary">
                    torrent and NZB indexers
                  </strong>
                  , configure your{" "}
                  <strong className="text-secondary">download clients</strong>{" "}
                  (qBittorrent, Transmission, SABnzbd, etc.), and browse content
                  with a gorgeous Netflix-inspired interface powered by TMDB.
                  Search across all your indexers simultaneously, monitor movies
                  and TV shows for automatic downloads, manage your media
                  library with Plex integration, and track everything in one
                  unified dashboard.
                </p>
                <p className="text-foreground/80 text-lg leading-relaxed">
                  <strong className="text-secondary">
                    100% legal, 100% transparent, 100% yours.
                  </strong>{" "}
                  BorrowArr is just a tool—you provide your own indexers and
                  download clients. It runs entirely on your infrastructure,
                  ensuring complete privacy and control. Whether you self-host
                  or use our managed platform, your data stays yours.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-foreground/60 text-lg max-w-2xl mx-auto">
                The ultimate media management solution designed for simplicity
                and power
              </p>
            </div>
              ...
              {keyBenefits.map((benefit, index) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-foreground/70 leading-relaxed text-base group-hover:text-foreground/90 transition-colors">
                      {benefit.description}
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-8">
              <div className="flex flex-col md:flex-row items-start gap-6 group hover-lift p-8 rounded-3xl transition-all bg-content2/50 border border-secondary/10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-foreground/70 text-lg group-hover:text-foreground/90 transition-colors leading-relaxed">
                    Add your torrent and NZB indexers, then connect your
                    download clients like qBittorrent, Transmission, or SABnzbd.
                    BorrowArr supports unlimited indexers and clients, giving
              ...
              <div className="flex flex-col md:flex-row items-start gap-6 group hover-lift p-8 rounded-3xl transition-all bg-content2/50 border border-secondary/10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-foreground/70 text-lg group-hover:text-foreground/90 transition-colors leading-relaxed">
                    Browse thousands of movies and TV shows with our beautiful,
                    Netflix-like interface. Filter by genre, year, rating,
                    streaming service, and more. When you find something you
                    want, simply request it with a single click.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-start gap-6 group hover-lift p-8 rounded-3xl transition-all bg-content2/50 border border-secondary/10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-foreground/70 text-lg group-hover:text-foreground/90 transition-colors leading-relaxed">
                    BorrowArr automatically searches all your indexers for the
                    best quality releases, sends them to your download clients,
                    and tracks everything in your history. Monitor progress,
                    manage your library, and enjoy your content—all from one
                    place.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="card-interactive group relative p-10 rounded-3xl bg-content2 border-2 border-secondary/30 hover:border-secondary/50 backdrop-blur-sm">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="text-5xl font-black text-secondary mb-4 neon-text">
                    FREE
                  </div>
                  <p className="text-foreground/70 mb-6 leading-relaxed">
                    Download and run BorrowArr on your own server. Complete
                    control, zero cost, unlimited everything.
                  </p>
              ...
              <div className="card-interactive group relative p-10 rounded-3xl bg-gradient-to-br from-secondary/20 to-secondary/10 border-2 border-secondary/50 hover:border-secondary backdrop-blur-sm">
                <div className="absolute top-4 right-4">
                  <Chip className="font-semibold" color="secondary" size="sm">
                    Coming Soon
                  </Chip>
                </div>
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-foreground/70 mb-6 leading-relaxed">
                    We host BorrowArr for you. Just bring your indexers and
                    download clients. Zero maintenance, maximum convenience.
                  </p>
                  <ul className="space-y-3 text-left mb-8">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-content1/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-content2/50 backdrop-blur-xl rounded-3xl p-8 border border-secondary/20">
              <p className="text-foreground/80 text-lg leading-relaxed mb-6">
                <strong className="text-secondary">
                  BorrowArr is a neutral tool
                </strong>
                —just like a web browser or text editor. We don't provide, host,
                or distribute any content. We don't operate any indexers or
                download services. BorrowArr simply provides an interface to
                manage <em>your</em> indexers and <em>your</em> download
                clients.
              </p>
              <p className="text-foreground/80 text-lg leading-relaxed mb-6">
                You are responsible for ensuring your usage complies with local
                laws and the terms of service of any indexers or download
                clients you connect. BorrowArr gives you the tools—how you use
            ...
            <div className="relative p-12 rounded-3xl bg-content2 border-2 border-secondary/30 backdrop-blur-sm hover-lift glow-border">
              ...
              <div className="relative z-10">
                ...
                <p className="text-foreground/80 text-xl mb-8 max-w-2xl mx-auto">
                  Join users who've already ditched the complexity. One app,
        ...
        <footer className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-secondary/20">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-secondary neon-text mb-2">
                BorrowArr
              </h3>
              <p className="text-foreground/60 mb-6">
                The unified media management platform. One app to replace them
                all.
              </p>
              <div className="flex flex-wrap justify-center gap-6 text-sm text-foreground/60">
                <a
                  className="hover:text-secondary transition-colors link-hover"
                  href="#"
                >
                  Documentation
                </a>
            ...
            <div className="text-center text-foreground/40 text-sm">
              ...
              <p className="text-xs">
                BorrowArr is a neutral tool. Users are responsible for their own
                indexers, download clients, and content choices.
              </p>
            </div>
          </div>
        </footer>
