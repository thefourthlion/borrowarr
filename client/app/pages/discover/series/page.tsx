...
const SeriesPage = () => {
  ...
  }, [firstAirDateFrom, firstAirDateTo, selectedGenres, keywords, originalLanguage, runtimeMin, runtimeMax, voteAverageMin, voteAverageMax, voteCountMin, selectedProviders, nudityFilter, violenceFilter, profanityFilter, alcoholFilter, frighteningFilter]);
  ...
  useEffect(() => {
    ...
    const fetchParentalGuideData = async () => {
      ...
      try {
        ...
        const seriesNeedingData = media.filter(series => !parentalGuideData.has(series.id));
        console.log(`📊 Series needing parental guide data: ${seriesNeedingData.length}`);
