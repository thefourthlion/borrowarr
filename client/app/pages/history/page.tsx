...
export default function HistoryPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-secondary/5">
      <PageHeader
        description="Track all your download requests"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
            ...
            <div className="bg-content1 border border-secondary/20 rounded-lg p-4 hover:border-secondary/40 transition-all">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-danger/10 rounded-lg">
                  <Film className="text-danger" size={20} />
                </div>
                <div>
                  <p className="text-sm text-default-500">Movies</p>
            ...
            <div className="bg-content1 border border-secondary/20 rounded-lg p-4 hover:border-secondary/40 transition-all">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-default-500">Series</p>
                  <p className="text-2xl font-bold">{stats.series}</p>
                </div>
              </div>
            </div>
            <div className="bg-content1 border border-secondary/20 rounded-lg p-4 hover:border-secondary/40 transition-all col-span-2 sm:col-span-1">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-default/20 rounded-lg">
                  <Download className="text-default-400" size={20} />
                </div>
                <div>
                  <p className="text-sm text-default-500">Unknown</p>
                  <p className="text-2xl font-bold">{stats.total - stats.movies - stats.series}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
            <Input
              ...
              classNames={{
                input: "text-small",
                inputWrapper:
                  "border border-secondary/20 hover:border-secondary/40 transition-colors h-10",
              }}
              onChange={(e) => {
            ...
            <Select
              ...
              classNames={{
                trigger:
                  "border border-secondary/20 hover:border-secondary/40 transition-colors h-10 min-h-10",
              }}
