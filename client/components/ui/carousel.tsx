...
>(
  (
    ...
    console.log(
      "[Carousel] Initializing with opts:",
      opts,
      "orientation:",
      orientation,
    );
    ...
    React.useEffect(() => {
      console.log("[Carousel] API state changed:", {
        api: !!api,
        canScrollPrev,
        canScrollNext,
      });
    ...
    const onSelect = React.useCallback((api: CarouselApi) => {
      ...
      console.log(
        "[Carousel] onSelect - canScrollPrev:",
        canPrev,
        "canScrollNext:",
        canNext,
      );
      console.log(
        "[Carousel] onSelect - scrollProgress:",
        scrollProgress,
        "slidesInView:",
        slidesInView,
        "totalSlides:",
      ...
      if (slideNodes && slideNodes.length > 0) {
        ...
        console.log(
          "[Carousel] onSelect - firstSlide width:",
          firstSlide?.offsetWidth,
          "lastSlide width:",
          lastSlide?.offsetWidth,
        );
        console.log(
          "[Carousel] onSelect - container width:",
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  console.log(
    "[CarouselPrevious] Rendering - canScrollPrev:",
    canScrollPrev,
    "orientation:",
    orientation,
  );
  ...
  return (
    <Button
      ...
      onClick={() => {
        console.log(
          "[CarouselPrevious] Clicked - canScrollPrev:",
          canScrollPrev,
        );
        scrollPrev();
      }}
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  console.log(
    "[CarouselNext] Rendering - canScrollNext:",
    canScrollNext,
    "orientation:",
    orientation,
  );
